        ...
        <div>
          <button
           onClick={()=>activeBtnClickHandler('Available')}
            className= {isActive ==='Available'? 'btn rounded-r-none  px-5 bg-highlight' : 'btn rounded-r-none  px-5'}
            >Available Players</button>
          <button
           onClick={()=>activeBtnClickHandler('Selected')}
            className={isActive ==='Selected'? 'btn rounded-r-none  px-5 bg-highlight' : 'btn rounded-l-none  px-5'}
            >Selected ({players}) </button>
        </div>
      </div>
      {/* main-container-content */}
      <div>
        {isActive === 'Available'? <Card data ={data}
